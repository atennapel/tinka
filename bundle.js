...
const convElim = (k, a, b, x, y) => {
    ...
    if (a.tag === 'EElimNat' && b.tag === 'EElimNat') {
        exports.conv(k, a.p, b.p);
        exports.conv(k, a.z, b.z);
        exports.conv(k, a.s, b.s);
        return;
    }
...
exports.conv = (k, a_, b_) => {
    ...
    if (a.tag === 'VType' && b.tag === 'VType')
        return;
    if (domain_1.isVUnit(a) || domain_1.isVUnit(b))
        return;
    if (a.tag === 'VData' && b.tag === 'VData' && a.cons.length === b.cons.length) {
        exports.conv(k, a.kind, b.kind);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.zonk = exports.showElim = exports.showElimQ = exports.showTermSZ = exports.showTermS = exports.showTermQZ = exports.showTermQ = exports.normalize = exports.quoteZ = exports.quote = exports.evaluate = exports.vdelim = exports.velimifix = exports.velimfin = exports.velimnat = exports.velimheq = exports.vproj = exports.vapp = exports.isCanonical = exports.forceGlue = exports.force = exports.showEnvV = exports.extendV = exports.isVUnit = exports.vheq = exports.VReflHEq = exports.VHEq = exports.VFS = exports.VFZ = exports.VFin = exports.VS = exports.VZ = exports.VNat = exports.VIFix = exports.VDataSort = exports.VPrim = exports.VMeta = exports.VGlobal = exports.VVar = exports.VCon = exports.VTCon = exports.VData = exports.VType = exports.VPair = exports.VSigma = exports.VPi = exports.VAbs = exports.VGlued = exports.VNe = exports.EDElim = exports.EElimIFix = exports.EElimFin = exports.EElimNat = exports.EElimHEq = exports.EProj = exports.EApp = exports.HPrim = exports.HMeta = exports.HGlobal = exports.HVar = void 0;
const list_1 = require("./utils/list");
...
exports.EElimNat = (p, z, s) => ({ tag: 'EElimNat', p, z, s });
exports.EElimFin = (p, z, s, n) => ({ tag: 'EElimFin', p, z, s, n });
exports.EElimIFix = (args) => ({ tag: 'EElimIFix', args });
exports.EDElim = (data, motive, args) => ({ tag: 'EDElim', data, motive, args });
...
exports.VData = (kind, cons) => ({ tag: 'VData', kind, cons });
exports.VTCon = (data, args) => ({ tag: 'VTCon', data, args });
exports.VCon = (ix, data, args) => ({ tag: 'VCon', ix, data, args });
...
exports.VS = (n) => exports.vapp(exports.VPrim('S'), false, n);
exports.VFin = exports.VPrim('Fin');
exports.VFZ = exports.VPrim('FZ');
exports.VFS = exports.VPrim('FS');
...
exports.isVUnit = (v) => {
    if (v.tag !== 'VNe' || v.head.tag !== 'HPrim' || v.head.name !== 'FZ')
        return false;
    const n = exports.force(v.args.head.arg);
    ...
    if (v.tag === 'VNe' && v.head.tag === 'HMeta') {
        ...
        return exports.force(list_1.foldr((elim, y) => elim.tag === 'EProj' ? exports.vproj(elim.proj, y) :
            elim.tag === 'EElimHEq' ? exports.velimheq([y].concat(elim.args)) :
                elim.tag === 'EElimIFix' ? exports.velimifix([y].concat(elim.args)) :
                    elim.tag === 'EElimNat' ? exports.velimnat(y, elim.p, elim.z, elim.s) :
                        elim.tag === 'EElimFin' ? exports.velimfin(y, elim.p, elim.z, elim.s, elim.n) :
                            elim.tag === 'EDElim' ? exports.vdelim(y, elim.data, elim.motive, elim.args) :
...
exports.velimnat = (v, p, z, s) => {
    if (v.tag === 'VNe') {
        ...
        if (v.head.tag === 'HPrim' && v.head.name === 'S') {
            ...
            const n = v.args.head.arg;
            return exports.vapp(s, false, n);
        }
        return exports.VNe(v.head, list_1.Cons(exports.EElimNat(p, z, s), v.args));
    }
    if (v.tag === 'VGlued')
        return exports.VGlued(v.head, list_1.Cons(exports.EElimNat(p, z, s), v.args), lazy_1.mapLazy(v.val, v => exports.velimnat(v, p, z, s)));
    return utils_1.impossible(`velimnat: ${v.tag}`);
};
exports.velimfin = (v, p, z, s, n) => {
    if (v.tag === 'VNe') {
        if (v.head.tag === 'HPrim' && v.head.name === 'FZ') {
            // elimFin {P} z s {n} (FZ {m}) ~> z {m}
            const m = v.args.head.arg;
            return exports.vapp(z, true, m);
        }
        if (v.head.tag === 'HPrim' && v.head.name === 'FS') {
            // elimNat {P} z s {n} (FS {m} x) ~> s {m} x
            const args = v.args;
            const x = args.head.arg;
            const m = args.tail.head.arg;
            return exports.vapp(exports.vapp(s, true, m), false, x);
        }
        return exports.VNe(v.head, list_1.Cons(exports.EElimFin(p, z, s, n), v.args));
    }
    if (v.tag === 'VGlued')
        return exports.VGlued(v.head, list_1.Cons(exports.EElimFin(p, z, s, n), v.args), lazy_1.mapLazy(v.val, v => exports.velimfin(v, p, z, s, n)));
    return utils_1.impossible(`velimnat: ${v.tag}`);
};
exports.velimifix = (args) => {
    const v = args[0];
    const rest = args.slice(1);
    if (v.tag === 'VNe') {
        if (v.head.tag === 'HPrim' && v.head.name === 'IIn') {
            ...
            const args = v.args;
            const x = args.head.arg;
            return exports.vapp(exports.vapp(rest[3], true, rest[4]), false, x);
        }
        return exports.VNe(v.head, list_1.Cons(exports.EElimIFix(rest), v.args));
    }
    if (v.tag === 'VGlued')
        return exports.VGlued(v.head, list_1.Cons(exports.EElimIFix(rest), v.args), lazy_1.mapLazy(v.val, v => exports.velimifix([v].concat(rest))));
    return utils_1.impossible(`velimifix: ${v.tag}`);
};
exports.vdelim = (v, data, motive, args) => {
    if (v.tag === 'VCon')
        return v.args.reduce((x, y) => exports.vapp(x, false, y), args[v.ix]);
    if (v.tag === 'VNe')
        return exports.VNe(v.head, list_1.Cons(exports.EDElim(data, motive, args), v.args));
    if (v.tag === 'VGlued')
        return exports.VGlued(v.head, list_1.Cons(exports.EDElim(data, motive, args), v.args), lazy_1.mapLazy(v.val, v => exports.vdelim(v, data, motive, args)));
    return utils_1.impossible(`vdelim: ${v.tag}`);
};
exports.evaluate = (t, vs = list_1.Nil) => {
    if (t.tag === 'Prim') {
        ...
        if (t.name === 'elimNat')
            return exports.VAbs(true, 'P', exports.VPi(false, '_', exports.VNat, _ => exports.VType), P => exports.VAbs(false, 'z', exports.vapp(P, false, exports.VZ), z => exports.VAbs(false, 's', exports.VPi(false, 'm', exports.VNat, m => exports.vapp(P, false, exports.VS(m))), s => exports.VAbs(false, 'n', exports.VNat, n => exports.velimnat(n, P, z, s)))));
        if (t.name === 'elimFin')
            return exports.VAbs(true, 'P', exports.VPi(false, 'n', exports.VNat, n => exports.VPi(false, '_', exports.vapp(exports.VFin, false, n), _ => exports.VType)), P => exports.VAbs(false, 'z', exports.VPi(true, 'm', exports.VNat, m => exports.vapp(exports.vapp(P, false, exports.VS(m)), false, exports.vapp(exports.VFZ, true, m))), z => exports.VAbs(false, 's', exports.VPi(true, 'm', exports.VNat, m => exports.VPi(false, 'y', exports.vapp(exports.VFin, false, m), y => exports.vapp(exports.vapp(P, false, exports.VS(m)), false, exports.vapp(exports.vapp(exports.VFS, true, m), false, y)))), s => exports.VAbs(true, 'n', exports.VNat, n => exports.VAbs(false, 'x', exports.vapp(exports.VFin, false, n), x => exports.velimfin(x, P, z, s, n))))));
        if (t.name === 'elimIFix')
            return exports.VAbs(true, 'I', exports.VType, I => exports.VAbs(true, 'F', exports.VPi(false, '_', exports.VPi(false, '_', I, _ => exports.VType), _ => exports.VPi(false, '_', I, _ => exports.VType)), F => exports.VAbs(true, 'P', exports.VPi(false, 'i', I, i => exports.VPi(false, '_', exports.vapp(exports.vapp(exports.vapp(exports.VIFix, false, I), false, F), false, i), _ => exports.VType)), P => exports.VAbs(false, 'r', exports.VPi(true, 'i', I, i => exports.VPi(false, 'z', exports.vapp(exports.vapp(F, false, exports.vapp(exports.vapp(exports.VIFix, false, I), false, F)), false, i), z => exports.vapp(exports.vapp(P, false, i), false, exports.vapp(exports.vapp(exports.vapp(exports.vapp(exports.VPrim('IIn'), true, I), true, F), true, i), false, z)))), r => exports.VAbs(true, 'i', I, i => exports.VAbs(false, 'x', exports.vapp(exports.vapp(exports.vapp(exports.VIFix, false, I), false, F), false, i), x => exports.velimifix([x, I, F, P, r, i])))))));
    ...
    if (t.tag === 'Data')
        return exports.VData(exports.evaluate(t.kind, vs), t.cons.map(x => exports.evaluate(x, vs)));
    if (t.tag === 'TCon')
        return exports.VTCon(exports.evaluate(t.data, vs), t.args.map(x => exports.evaluate(x, vs)));
    if (t.tag === 'Con')
        return exports.VCon(t.ix, exports.evaluate(t.data, vs), t.args.map(x => exports.evaluate(x, vs)));
    if (t.tag === 'DElim')
        return exports.vdelim(exports.evaluate(t.scrut, vs), exports.evaluate(t.data, vs), exports.evaluate(t.motive, vs), t.args.map(x => exports.evaluate(x, vs)));
    return t;
};
const quoteHead = (h, k) => {
    if (h.tag === 'HVar')
...
const quoteElim = (t, e, k, full) => {
    ...
    if (e.tag === 'EDElim')
        return syntax_1.DElim(exports.quote(e.data, k, full), exports.quote(e.motive, k, full), t, e.args.map(x => exports.quote(x, k, full)));
    if (e.tag === 'EElimHEq') {
    ...
    if (e.tag === 'EElimNat') {
        const [P, z, s] = [e.p, e.z, e.s].map(x => exports.quote(x, k, full));
        return syntax_1.App(syntax_1.App(syntax_1.App(syntax_1.App(syntax_1.Prim('elimNat'), true, P), false, z), false, s), false, t);
    }
    if (e.tag === 'EElimFin') {
        const [P, z, s, n] = [e.p, e.z, e.s, e.n].map(x => exports.quote(x, k, full));
        return syntax_1.App(syntax_1.App(syntax_1.App(syntax_1.App(syntax_1.App(syntax_1.Prim('elimFin'), true, P), false, z), false, s), true, n), false, t);
    }
    if (e.tag === 'EElimIFix') {
        const [I, F, P, f, i] = e.args.map(x => exports.quote(x, k, full));
        return syntax_1.App(syntax_1.App(syntax_1.App(syntax_1.App(syntax_1.App(syntax_1.App(syntax_1.Prim('elimIFix'), true, I), true, F), true, P), false, f), true, i), false, t);
    }
    return e;
};
exports.quote = (v_, k, full) => {
    ...
    if (v.tag === 'VData')
        return syntax_1.Data(exports.quote(v.kind, k, full), v.cons.map(x => exports.quote(x, k, full)));
    if (v.tag === 'VTCon')
        return syntax_1.TCon(exports.quote(v.data, k, full), v.args.map(x => exports.quote(x, k, full)));
    if (v.tag === 'VCon')
        return syntax_1.Con(v.ix, exports.quote(v.data, k, full), v.args.map(x => exports.quote(x, k, full)));
    return v;
};
...
exports.showElim = (e, ns = list_1.Nil, k = 0, full = false) => {
    ...
    if (e.tag === 'EProj')
        return e.proj;
    if (e.tag === 'EDElim')
        return `delim ${[e.data, e.motive].concat(e.args).map(x => exports.showTermS(x, ns, k, full)).join(' ')}`;
    if (e.tag === 'EElimHEq')
        return `elimheq ${e.args.map(x => exports.showTermS(x, ns, k, full)).join(' ')}`;
    if (e.tag === 'EElimIFix')
        return `elimifix ${e.args.map(x => exports.showTermS(x, ns, k, full)).join(' ')}`;
    if (e.tag === 'EElimNat')
        return `elimnat ${[e.p, e.z, e.s].map(x => exports.showTermS(x, ns, k, full)).join(' ')}`;
    if (e.tag === 'EElimFin')
        return `elimfin ${[e.p, e.z, e.s, e.n].map(x => exports.showTermS(x, ns, k, full)).join(' ')}`;
    return e;
};
...
exports.zonk = (tm, vs = list_1.Nil, k = 0, full = false) => {
    ...
    if (tm.tag === 'Data')
        return syntax_1.Data(exports.zonk(tm.kind, vs, k, full), tm.cons.map(x => exports.zonk(x, vs, k, full)));
    if (tm.tag === 'TCon')
        return syntax_1.TCon(exports.zonk(tm.data, vs, k, full), tm.args.map(x => exports.zonk(x, vs, k, full)));
    if (tm.tag === 'Con')
        return syntax_1.Con(tm.ix, exports.zonk(tm.data, vs, k, full), tm.args.map(x => exports.zonk(x, vs, k, full)));
    if (tm.tag === 'DElim')
        return syntax_1.DElim(exports.zonk(tm.data, vs, k, full), exports.zonk(tm.motive, vs, k, full), exports.zonk(tm.scrut, vs, k, full), tm.args.map(x => exports.zonk(x, vs, k, full)));
    return tm;
};
...
const exprs = (ts, br) => {
    ...
    if (isName(ts[0], 'data')) {
        const args = ts.slice(1).map(x => {
            const [t, b] = expr(x);
            if (b)
                return utils_1.serr(`data arg cannot be implicit`);
            return t;
        });
        if (args.length === 0)
            return surface_1.Data(surface_1.Type, []);
        return surface_1.Data(args[0], args.slice(1));
    }
    if (isName(ts[0], 'tcon')) {
        const args = ts.slice(1).map(x => {
            const [t, b] = expr(x);
            if (b)
                return utils_1.serr(`tcon arg cannot be implicit`);
            return t;
        });
        if (args.length === 0)
            return utils_1.serr(`tcon needs arg`);
        return surface_1.TCon(args[0], args.slice(1));
    }
    if (isName(ts[0], 'con')) {
        const ix = ts[1];
        if (ix.tag !== 'Num')
        ...
        if (args.length === 0)
            return utils_1.serr(`con needs arg`);
        return surface_1.Con(+ix.num, args[0], args.slice(1));
    }
    if (isName(ts[0], 'elim')) {
        const args = ts.slice(1).map(x => {
            const [t, b] = expr(x);
        ...
        if (args.length < 3)
            return utils_1.serr(`elim needs args`);
        return surface_1.DElim(args[0], args[1], args[2], args.slice(3));
    }
    if (isName(ts[0], '\\')) {
        const args = [];
        let found = false;
...
const primTypes = {
    ...
    'elimNat': () => domain_1.VPi(true, 'P', domain_1.VPi(false, '_', domain_1.VNat, _ => domain_1.VType), P => domain_1.VPi(false, '_', domain_1.vapp(P, false, domain_1.VZ), _ => domain_1.VPi(false, '_', domain_1.VPi(false, 'm', domain_1.VNat, m => domain_1.vapp(P, false, domain_1.VS(m))), _ => domain_1.VPi(false, 'n', domain_1.VNat, n => domain_1.vapp(P, false, n))))),
    'Fin': () => domain_1.VPi(false, '_', domain_1.VNat, _ => domain_1.VType),
    'FZ': () => domain_1.VPi(true, 'n', domain_1.VNat, n => domain_1.vapp(domain_1.VFin, false, domain_1.VS(n))),
    'FS': () => domain_1.VPi(true, 'n', domain_1.VNat, n => domain_1.VPi(false, '_', domain_1.vapp(domain_1.VFin, false, n), _ => domain_1.vapp(domain_1.VFin, false, domain_1.VS(n)))),
    // {P : (n : Nat) -> Fin n -> *} -> ({m : Nat} -> P (S m) (FZ {m})) -> ({m : Nat} -> (y : Fin m) -> P (S m) (FS {m} y)) -> {n : Nat} -> (x : Fin n) -> P n f
    'elimFin': () => domain_1.VPi(true, 'P', domain_1.VPi(false, 'n', domain_1.VNat, n => domain_1.VPi(false, '_', domain_1.vapp(domain_1.VFin, false, n), _ => domain_1.VType)), P => domain_1.VPi(false, '_', domain_1.VPi(true, 'm', domain_1.VNat, m => domain_1.vapp(domain_1.vapp(P, false, domain_1.VS(m)), false, domain_1.vapp(domain_1.VFZ, true, m))), _ => domain_1.VPi(false, '_', domain_1.VPi(true, 'm', domain_1.VNat, m => domain_1.VPi(false, 'y', domain_1.vapp(domain_1.VFin, false, m), y => domain_1.vapp(domain_1.vapp(P, false, domain_1.VS(m)), false, domain_1.vapp(domain_1.vapp(domain_1.VFS, true, m), false, y)))), _ => domain_1.VPi(true, 'n', domain_1.VNat, n => domain_1.VPi(false, 'x', domain_1.vapp(domain_1.VFin, false, n), x => domain_1.vapp(domain_1.vapp(P, false, n), false, x)))))),
    // {P : Fin 0 -> *} -> (x : Fin 0) -> P x
    'elimFin0': () => domain_1.VPi(true, 'P', domain_1.VPi(false, '_', domain_1.vapp(domain_1.VFin, false, domain_1.VZ), _ => domain_1.VType), P => domain_1.VPi(false, 'x', domain_1.vapp(domain_1.VFin, false, domain_1.VZ), x => domain_1.vapp(P, false, x))),
    // (I : *) -> ((I -> *) -> I -> *) -> I -> *
    ...
    /*
      ...
      -> P i x
    */
    'elimIFix': () => domain_1.VPi(true, 'I', domain_1.VType, I => domain_1.VPi(true, 'F', domain_1.VPi(false, '_', domain_1.VPi(false, '_', I, _ => domain_1.VType), _ => domain_1.VPi(false, '_', I, _ => domain_1.VType)), F => domain_1.VPi(true, 'P', domain_1.VPi(false, 'i', I, i => domain_1.VPi(false, '_', domain_1.vapp(domain_1.vapp(domain_1.vapp(domain_1.VIFix, false, I), false, F), false, i), _ => domain_1.VType)), P => domain_1.VPi(false, '_', domain_1.VPi(true, 'i', I, i => domain_1.VPi(false, 'z', domain_1.vapp(domain_1.vapp(F, false, domain_1.vapp(domain_1.vapp(domain_1.VIFix, false, I), false, F)), false, i), z => domain_1.vapp(domain_1.vapp(P, false, i), false, domain_1.vapp(domain_1.vapp(domain_1.vapp(domain_1.vapp(domain_1.VPrim('IIn'), true, I), true, F), true, i), false, z)))), _ => domain_1.VPi(true, 'i', I, i => domain_1.VPi(false, 'x', domain_1.vapp(domain_1.vapp(domain_1.vapp(domain_1.VIFix, false, I), false, F), false, i), x => domain_1.vapp(domain_1.vapp(P, false, i), false, x))))))),
};
...
exports.Data = (kind, cons) => ({ tag: 'Data', kind, cons });
exports.TCon = (data, args) => ({ tag: 'TCon', data, args });
exports.Con = (ix, data, args) => ({ tag: 'Con', ix, data, args });
exports.DElim = (data, motive, scrut, args) => ({ tag: 'DElim', data, motive, scrut, args });
...
exports.showTermS = (t) => {
    ...
    if (t.tag === 'Data')
        return `(data ${exports.showTermS(t.kind)}${t.cons.length > 0 ? ` ${t.cons.map(exports.showTermS).join(' ')}` : ''})`;
    if (t.tag === 'TCon')
        return `(tcon ${exports.showTermS(t.data)}${t.args.length > 0 ? ` ${t.args.map(exports.showTermS).join(' ')}` : ''})`;
    if (t.tag === 'Con')
        return `(con ${t.ix} ${exports.showTermS(t.data)}${t.args.length > 0 ? ` ${t.args.map(exports.showTermS).join(' ')}` : ''})`;
    if (t.tag === 'DElim')
        return `(elim ${exports.showTermS(t.data)} ${exports.showTermS(t.motive)} ${exports.showTermS(t.scrut)}${t.args.length > 0 ? ` ${t.args.map(exports.showTermS).join(' ')}` : ''})`;
    return t;
};
...
exports.showTerm = (t) => {
    ...
    if (t.tag === 'App') {
        ...
        return `${exports.showTermP(f.tag === 'Abs' || f.tag === 'Pi' || f.tag === 'Sigma' || f.tag === 'App' || f.tag === 'Let' || f.tag === 'Ann' || f.tag === 'Proj' || f.tag === 'Data' || f.tag === 'TCon' || f.tag === 'Con' || f.tag === 'DElim', f)} ${as.map(([im, t], i) => im ? `{${exports.showTerm(t)}}` :
            `${exports.showTermP(t.tag === 'App' || t.tag === 'Ann' || t.tag === 'Let' || (t.tag === 'Abs' && i < as.length - 1) || t.tag === 'Pi' || t.tag === 'Sigma' || t.tag === 'Proj' || t.tag === 'Data' || t.tag === 'TCon' || t.tag === 'Con' || t.tag === 'DElim', t)}`).join(' ')}`;
    }
    if (t.tag === 'Abs') {
    ...
    if (t.tag === 'Hole')
        return `_${t.name || ''}`;
    if (t.tag === 'Proj')
        return `.${t.proj.tag === 'PName' ? t.proj.name : t.proj.tag === 'PIndex' ? t.proj.index : t.proj.proj} ${exports.showTermP(t.term.tag !== 'Var' && t.term.tag !== 'Meta' && t.term.tag !== 'Prim' && t.term.tag !== 'Type', t.term)}`;
    if (t.tag === 'Data')
        return `data ${exports.showTermP(t.kind.tag !== 'Var' && t.kind.tag !== 'Meta' && t.kind.tag !== 'Prim' && t.kind.tag !== 'Type', t.kind)}${t.cons.length > 0 ? ` ${t.cons.map(x => exports.showTermP(x.tag !== 'Var' && x.tag !== 'Meta' && x.tag !== 'Prim' && x.tag !== 'Type', x)).join(' ')}` : ''}`;
    if (t.tag === 'TCon')
        return `tcon ${exports.showTermP(t.data.tag !== 'Var' && t.data.tag !== 'Meta' && t.data.tag !== 'Prim' && t.data.tag !== 'Type', t.data)}${t.args.length > 0 ? ` ${t.args.map(x => exports.showTermP(x.tag !== 'Var' && x.tag !== 'Meta' && x.tag !== 'Prim' && x.tag !== 'Type', x)).join(' ')}` : ''}`;
    if (t.tag === 'Con')
        return `con ${t.ix} ${exports.showTermP(t.data.tag !== 'Var' && t.data.tag !== 'Meta' && t.data.tag !== 'Prim' && t.data.tag !== 'Type', t.data)}${t.args.length > 0 ? ` ${t.args.map(x => exports.showTermP(x.tag !== 'Var' && x.tag !== 'Meta' && x.tag !== 'Prim' && x.tag !== 'Type', x)).join(' ')}` : ''}`;
    if (t.tag === 'DElim')
        return `elim ${exports.showTermP(t.data.tag !== 'Var' && t.data.tag !== 'Meta' && t.data.tag !== 'Prim' && t.data.tag !== 'Type', t.data)} ${exports.showTermP(t.motive.tag !== 'Var' && t.motive.tag !== 'Meta' && t.motive.tag !== 'Prim' && t.motive.tag !== 'Type', t.motive)} ${exports.showTermP(t.scrut.tag !== 'Var' && t.scrut.tag !== 'Meta' && t.scrut.tag !== 'Prim' && t.scrut.tag !== 'Type', t.scrut)}${t.args.length > 0 ? ` ${t.args.map(x => exports.showTermP(x.tag !== 'Var' && x.tag !== 'Meta' && x.tag !== 'Prim' && x.tag !== 'Type', x)).join(' ')}` : ''}`;
    return t;
};
exports.erase = (t) => {
    if (t.tag === 'Hole')
    ...
    if (t.tag === 'Data')
        return exports.Data(exports.erase(t.kind), t.cons.map(exports.erase));
    if (t.tag === 'TCon')
    ...
    if (t.tag === 'DElim')
        return exports.DElim(exports.Type, exports.Type, exports.erase(t.scrut), t.args.map(exports.erase));
    return t;
};
...
exports.showTerm = (t) => {
    ...
    if (t.tag === 'Data')
        return `(data ${exports.showTerm(t.kind)}${t.cons.length > 0 ? ` ${t.cons.map(exports.showTerm).join(' ')}` : ''})`;
    if (t.tag === 'TCon')
        return `(tcon ${exports.showTerm(t.data)}${t.args.length > 0 ? ` ${t.args.map(exports.showTerm).join(' ')}` : ''})`;
    if (t.tag === 'Con')
        return `(con ${t.ix} ${exports.showTerm(t.data)}${t.args.length > 0 ? ` ${t.args.map(exports.showTerm).join(' ')}` : ''})`;
    if (t.tag === 'DElim')
        return `(elim ${exports.showTerm(t.data)} ${exports.showTerm(t.motive)} ${exports.showTerm(t.scrut)}${t.args.length > 0 ? ` ${t.args.map(exports.showTerm).join(' ')}` : ''})`;
    return t;
};
exports.globalUsed = (k, t) => {
    ...
    if (t.tag === 'Sigma')
        return exports.globalUsed(k, t.type) || exports.globalUsed(k, t.body);
    if (t.tag === 'Data')
        return exports.globalUsed(k, t.kind) || t.cons.some(x => exports.globalUsed(k, x));
    if (t.tag === 'TCon')
        return exports.globalUsed(k, t.data) || t.args.some(x => exports.globalUsed(k, x));
    if (t.tag === 'Con')
        return exports.globalUsed(k, t.data) || t.args.some(x => exports.globalUsed(k, x));
    if (t.tag === 'DElim')
        return exports.globalUsed(k, t.data) || exports.globalUsed(k, t.motive) || exports.globalUsed(k, t.scrut) || t.args.some(x => exports.globalUsed(k, x));
    return false;
};
exports.indexUsed = (k, t) => {
    ...
    if (t.tag === 'Data')
        return exports.indexUsed(k, t.kind) || t.cons.some(x => exports.indexUsed(k, x));
    if (t.tag === 'TCon')
        return exports.indexUsed(k, t.data) || t.args.some(x => exports.indexUsed(k, x));
    if (t.tag === 'Con')
        return exports.indexUsed(k, t.data) || t.args.some(x => exports.indexUsed(k, x));
    if (t.tag === 'DElim')
        return exports.indexUsed(k, t.data) || exports.indexUsed(k, t.motive) || exports.indexUsed(k, t.scrut) || t.args.some(x => exports.indexUsed(k, x));
    return false;
};
exports.isUnsolved = (t) => {
    ...
    if (t.tag === 'Data')
        return exports.isUnsolved(t.kind) || t.cons.some(x => exports.isUnsolved(x));
    if (t.tag === 'TCon')
        return exports.isUnsolved(t.data) || t.args.some(x => exports.isUnsolved(x));
    if (t.tag === 'Con')
        return exports.isUnsolved(t.data) || t.args.some(x => exports.isUnsolved(x));
    if (t.tag === 'DElim')
        return exports.isUnsolved(t.data) || exports.isUnsolved(t.motive) || exports.isUnsolved(t.scrut) || t.args.some(x => exports.isUnsolved(x));
    return false;
};
...
exports.toSurface = (t, ns = list_1.Nil) => {
    ...
    if (t.tag === 'Data')
        return S.Data(exports.toSurface(t.kind, ns), t.cons.map(x => exports.toSurface(x, ns)));
    if (t.tag === 'TCon')
        return S.TCon(exports.toSurface(t.data, ns), t.args.map(x => exports.toSurface(x, ns)));
    if (t.tag === 'Con')
        return S.Con(t.ix, exports.toSurface(t.data, ns), t.args.map(x => exports.toSurface(x, ns)));
    if (t.tag === 'DElim')
        return S.DElim(exports.toSurface(t.data, ns), exports.toSurface(t.motive, ns), exports.toSurface(t.scrut, ns), t.args.map(x => exports.toSurface(x, ns)));
    return t;
};
...
const check = (local, tm, ty) => {
    ...
    if (tm.tag === 'Type' && fty === domain_1.VType)
        return syntax_1.Type;
    if (tm.tag === 'Hole') {
...
const synth = (local, tm) => {
    ...
    if (tm.tag === 'Data') {
        const kind = check(exports.localInType(local), tm.kind, domain_1.VType);
        const contype = domain_1.VPi(false, '_', domain_1.evaluate(kind, local.vs), _ => domain_1.VType);
        const cons = tm.cons.map(con => check(exports.localInType(local), con, contype));
        return [syntax_1.Data(kind, cons), domain_1.VDataSort];
    }
    if (tm.tag === 'TCon') {
        const data = check(exports.localInType(local), tm.data, domain_1.VDataSort);
        const vdata = domain_1.evaluate(data, local.vs);
    ...
    if (tm.tag === 'Con') {
        ...
        const fdata = domain_1.force(vdata);
        if (fdata.tag !== 'VData')
            return utils_1.terr(`not data in con: ${S.showTerm(tm)}`);
    ...
    if (tm.tag === 'DElim') {
        ...
        if (fdata.tag !== 'VData')
            return utils_1.terr(`not data in con: ${S.showTerm(tm)}`);
        const type = domain_1.VTCon(vdata, []);
        const motive = check(exports.localInType(local), tm.motive, domain_1.VPi(false, '_', type, _ => domain_1.VType));
        const vmotive = domain_1.evaluate(motive, local.vs);
...
const unifyElim = (k, a, b, x, y) => {
    ...
    if (a.tag === 'EDElim' && b.tag === 'EDElim') {
        ...
        exports.unify(k, a.motive, b.motive);
        for (let i = 0; i < a.args.length; i++)
    ...
    if (a.tag === 'EElimNat' && b.tag === 'EElimNat') {
        exports.unify(k, a.p, b.p);
        exports.unify(k, a.z, b.z);
        exports.unify(k, a.s, b.s);
        return;
    }
    if (a.tag === 'EElimFin' && b.tag === 'EElimFin') {
        exports.unify(k, a.p, b.p);
...
const checkSolution = (k, m, is, t) => {
    ...
    if (t.tag === 'Data') {
        ...
        return syntax_1.Data(kind, cons);
    }
    if (t.tag === 'TCon') {
        const data = checkSolution(k, m, is, t.data);
        const args = t.args.map(x => checkSolution(k, m, is, x));
        return syntax_1.TCon(data, args);
    }
    if (t.tag === 'Con') {
        const data = checkSolution(k, m, is, t.data);
        const args = t.args.map(x => checkSolution(k, m, is, x));
        return syntax_1.Con(t.ix, data, args);
    }
    if (t.tag === 'DElim') {
        const data = checkSolution(k, m, is, t.data);
        ...
        const args = t.args.map(x => checkSolution(k, m, is, x));
        return syntax_1.DElim(data, motive, scrut, args);
    }
...
const synth = (local, tm) => {
    ...
    if (tm.tag === 'Data') {
        check(exports.localInType(local), tm.kind, domain_1.VType);
        const contype = domain_1.VPi(false, '_', domain_1.evaluate(tm.kind, local.vs), _ => domain_1.VType);
        tm.cons.forEach(con => check(exports.localInType(local), con, contype));
        return domain_1.VDataSort;
    }
    if (tm.tag === 'TCon') {
        check(exports.localInType(local), tm.data, domain_1.VDataSort);
        const vdata = domain_1.evaluate(tm.data, local.vs);
        const fdata = domain_1.force(vdata);
        if (fdata.tag !== 'VData')
    ...
    if (tm.tag === 'Con') {
        ...
        const fdata = domain_1.force(vdata);
        if (fdata.tag !== 'VData')
            return utils_1.terr(`not data in con: ${syntax_1.showTerm(tm)}`);
        const con = fdata.cons[tm.ix];
        if (!con)
    ...
    if (tm.tag === 'DElim') {
        ...
        if (fdata.tag !== 'VData')
            return utils_1.terr(`not data in con: ${syntax_1.showTerm(tm)}`);
        const type = domain_1.VTCon(vdata, []);
        check(exports.localInType(local), tm.motive, domain_1.VPi(false, '_', type, _ => domain_1.VType));
        const vmotive = domain_1.evaluate(tm.motive, local.vs);
